...
<head>
    ...
    <title>Add Work Experience - Regret Consultancy</title>
    ...
    <main class="pt-16 p-4 md:p-6 md:ml-64 mt-10">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="card rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-4 md:p-6 border-b border-slate-200">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-[#1e293b]">Add New Work Experience</h3>

                            <p class="text-sm text-slate-500 mt-1">Create a new work experience entry</p>
                ...
                <form method="POST" action="{{ route('workexperiences.store') }}" enctype="multipart/form-data"
                    class="p-4 md:p-6">
